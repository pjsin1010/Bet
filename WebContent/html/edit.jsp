...
<table width="1134" border="0" cellspacing="0" cellpadding="0" class="boardWrite" style="margin-top:15px;" align="center">
	<tbody><tr><input type="hidden" name="num" value="<%=num %>">
		<th width="123">제목</th>
		<td width="807" class="title"><input type="text" name="title" id="idc" class="input6" value="<%=dto.getTitle() %>"></td>
	</tr>
	<tr>
		<th>작성자</th>
	...
	<tr>
		...
		<td class="content"><textarea name="board" id="idd" cols="25" rows="15" class="board" ><%=dto.getBoard() %></textarea></td>
